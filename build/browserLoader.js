...
var _abstractLoader = require('./abstractLoader');
...
var BrowserLoader = function(_AbstractLoader) {
  ...
  function BrowserLoader(plugins) {
    _classCallCheck(this, BrowserLoader);
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BrowserLoader).call(this, plugins));
